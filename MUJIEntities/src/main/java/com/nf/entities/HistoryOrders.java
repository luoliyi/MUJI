...
public class HistoryOrders {
    ...
    * */
    ...
    public HistoryOrders(String mphone, int gid, int ocount, double osumprice, String cono, int ostate) {
        this.mphone = mphone;
        this.gid = gid;
        this.ocount = ocount;
        this.osumprice = osumprice;
    ...
    public HistoryOrders(int orderid, String mphone, int gid, int ocount, double osumprice, String cono, int ostate) {
        this.orderid = orderid;
        this.mphone = mphone;
        this.gid = gid;
        this.ocount = ocount;
